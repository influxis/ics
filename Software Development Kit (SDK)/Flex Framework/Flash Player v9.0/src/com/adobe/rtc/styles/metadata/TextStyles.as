...
/**
 *  Sets the <code class="property">antiAliasType</code> property of internal TextFields. The possible values are 
...
/**
 *  Sets the <code class="property">gridFitType</code> property of internal TextFields that represent text in Flex controls.
 ...
 *  and the <code class="property">fontAntiAliasType</code> property 
...
/**
 *  Sets the <code class="property">sharpness</code> property of internal TextFields that represent text in Flex controls.
...
/**
 *  Sets the <code class="property">thickness</code> property of internal TextFields that represent text in Flex controls.
 ...
 *  <code class="property">labelPlacement</code> property is set to <code>"left"</code> or
 *  <code>right</code>.
 *  If <code class="property">labelPlacement</code> is set to <code>top</code> or
