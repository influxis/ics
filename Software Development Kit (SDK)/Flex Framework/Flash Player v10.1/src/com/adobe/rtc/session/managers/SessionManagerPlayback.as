...
package com.adobe.rtc.session.managers
{
	...
	public class SessionManagerPlayback extends SessionManagerAdobeHostedServices
	{
		...
		public function set archiveID(p_archiveID:String):void {
			_archiveID = p_archiveID.toLowerCase();
		}
		
		/**
		 * Legacy method; keeping around a little longer just in case.
		 * TODO: We should remove it in the next release.
		 */
		...
		override protected function setupMeetingInfo():void
		{
			super.setupMeetingInfo();
			
			// add playback specifics
			this._meetingInfo.setArchiveID(archiveID);
		}
		 ...
		 * @private
		 */
		public function onTimeCoordInfo(p_obj:*):void
		{
			// NO-OP. Just working around ridiculous player code
		}
