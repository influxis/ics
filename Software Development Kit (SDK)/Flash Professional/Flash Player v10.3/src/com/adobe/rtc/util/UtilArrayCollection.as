...
package com.adobe.rtc.util
{
	...
	[Event(name="replace", type="ArrayCollectionChangeEvent")]
	[Event(name="add", type="ArrayCollectionChangeEvent")]
	[Event(name="remove", type="ArrayCollectionChangeEvent")]
	[Event(name="removeAll", type="ArrayCollectionChangeEvent")]
