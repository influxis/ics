...
package com.adobe.rtc.collaboration
{
   ...
   public class  FilePublisher extends EventDispatcher implements ISessionSubscriber
	{
		/**
        ...
        * @default null
		...
		{			
			...
			if(p_fileDesc.name != null && p_newName != null) {		
				...
				var groupDescriptors:UtilArrayCollection = _fileManager.getFileDescriptors(_groupName);
