   ...
   public class  SimpleChatModel extends EventDispatcher implements ISessionSubscriber
	{
		 ...
		 * @private
		 */
		protected var _usersTyping:UtilArrayCollection;
		/**
		 * @private
		 */
		protected var _userWithoutUserDescriptorTyping:UtilArrayCollection;
		/**
		 * @private
		 */
		 ...
		 */
		 public function subscribe():void
		 {
			...
			_usersTyping = new UtilArrayCollection();
			_userWithoutUserDescriptorTyping = new UtilArrayCollection();
