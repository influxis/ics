   ...
   public class  AdobeHSAuthenticator extends AbstractAuthenticator
	{
		...
		* 
		* @param p_proto The protocol. Default to RTMPS
		*/
		public function set protocol(p_proto:String):void
		{
			SessionManagerAdobeHostedServices(session_internal::sessionManager).protocol = p_proto;
		}
		 ...
		 */
		public function set requireRTMFP(p_req:Boolean):void
		{
			SessionManagerAdobeHostedServices(session_internal::sessionManager).requireRTMFP = p_req;
		}
