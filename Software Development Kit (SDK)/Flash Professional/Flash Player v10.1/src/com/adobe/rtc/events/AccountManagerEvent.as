   ...
   public class  AccountManagerEvent extends Event
	{
		...
		/**
		 * Event type emitted when a call to <code>deleteArchive</code> has returned
		 */
		public static const ARCHIVE_DELETE:String = "archiveDelete";
		/**
		 * Event type emitted when a call to <code>moveArchive</code> has returned
		 */
		public static const ARCHIVE_MOVE:String = "archiveMove";			
		/**
		...
		/**
		 * For TEMPLATE_LIST_RECEIVE, ROOM_LIST_RECEIVE, or ARCHIVE_LIST_RECEIVE the list of templates, rooms, or archives. 
		 * This is returned as an array of objects with details about the rooms, templates, or archives.
		 */
		...
		/**
		 * For ARCHIVE_DELETE, the name of the archive affected
		 */
