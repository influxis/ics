package
{
	...
	{
		private var upColor:uint   = 0xAF3b3b;
	    private var overColor:uint = 0xAFAFAF;
	    private var downColor:uint = 0xAFAF00;
	    private var buttonWidth:uint      = 140;
		private var buttonHeight:uint      = 25;

	
	    public function CustomSimpleButton(p_label:String)
	    {
			var cButton:ButtonDisplayState   = new ButtonDisplayState(upColor, buttonWidth, buttonHeight, p_label);
